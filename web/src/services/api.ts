...
// Usa SEMPRE URL assoluto basato su window.location.origin per bypassare il bug Chrome
// che blocca fetch quando la pagina ha credentials inline (user:pwd@host) in baseURI.
